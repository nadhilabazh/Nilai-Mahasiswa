...
<input class="form-control" type="text" name="nim" id="nim" required></div>
</li>

<li class="list-group-item">
	<label for="nama_mhs"><h5> Nama_Mhs </h5></label></td>
	<div class="col mt-2 mb-2">
	<div class="row text-center">
	<input class="form-control" type="text" name="nama_mhs" id="nama_mhs" required ></div>
</li>
	...
	<div class="col mt-2 mb-2">
	<div class="row text-center">
	<input class="form-control" type="text" name="tugas" id="tugas" required ></div>
</li>
...
<li class="list-group-item">
	...
	<div class="col mt-2 mb-2">
	<div class="row text-center">
	<input class="form-control" type="text" name="uts" id="uts" required ></div>
</li>
...
<li class="list-group-item">
	...
	<div class="col mt-2 mb-2">
	<div class="row text-center">
	<input class="form-control" type="text" name="uas" id="uas" required ></div>
</li>

<li class="list-group-item">
	<label for="Foto_mhs"><h5> Foto Mhs </h5></label></td>
	<div class="col mt-2 mb-2">
	<div class="row text-center">
		<div class="col-md-8">
